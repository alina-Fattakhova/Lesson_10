...
public class EmailTest {
  ...
  public void email() {
    ...
    driver.manage().window().setSize(new Dimension(1230, 692));
    driver.findElement(By.linkText("Регистрация")).click();
    driver.findElement(By.id("signupform-username")).click();
    driver.findElement(By.id("signupform-username")).sendKeys("AF_andersen");
    driver.findElement(By.id("signupform-password")).click();
    driver.findElement(By.id("signupform-password")).sendKeys("Student2020!");
    driver.findElement(By.id("signupform-email")).click();
    driver.findElement(By.id("signupform-email")).sendKeys("spiritusdentatus@gmail.com");
